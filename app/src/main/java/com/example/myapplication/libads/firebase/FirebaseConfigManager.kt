...
class FirebaseConfigManager {
    ...
    fun fetch(onFetchComplete: (() -> Unit)? = null) {
        ...
        FirebaseRemoteConfig.getInstance().fetch(longCache).addOnCompleteListener { task ->
            if (task.isSuccessful) {
                ...
                Log.e("TAG_FirebaseConfigManager","FirebaseConfigManager : $json")
                if (json.isEmpty()) {
                    ...
                    try {
                        ...
                        tryFetchAgain(onFetchComplete)
                        Log.e("TAG_FirebaseConfigManager","FirebaseConfigManager : ${e.message}")
                ...
                tryFetchAgain(onFetchComplete)
                Log.e("TAG_FirebaseConfigManager","load config fail")
            }
        }
    }
    ...
    fun getString(key: String, defaultValue: String = ""): String {
        return try {
            ...
            Log.e("TAG_FirebaseConfigManager", "getString() error: ${e.message}")
            defaultValue
        }
    }
    ...
    fun getBoolean(key: String, defaultValue: Boolean = false): Boolean {
        return try {
            ...
            Log.e("TAG_FirebaseConfigManager", "getBoolean() error: ${e.message}")
            defaultValue
        }
    }
    ...
    fun getLong(key: String, defaultValue: Long = 0L): Long {
        return try {
            ...
            Log.e("TAG_FirebaseConfigManager", "getLong() error: ${e.message}")
            defaultValue
        }
    }
}